...
\begin{center}
    ...
    \vspace{1cm}  \small Kwtee ngnouba junior rayan  ictu20241377\\
      \small  Izuchuku chijioke emmanuel ictu20241377\\ \small \\
    \vspace{1cm}
    This document contains proprietary information of the Smart Tutor project.\\
    supervisor: Eng Tekoh Palma
\end{center}
\vspace*{\fill}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{compoet.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{class daigrm.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{pdf deletion sequence.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{statediagram.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{sentimentlifecycle.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{deploymetarchitechure.png}
